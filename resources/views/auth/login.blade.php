...
<div class="h-100 bg-cover bg-center py-5 d-flex align-items-center" style="background-image: url('https://taketalkbd.com/public/uploads/all/GhsYhGrlNLDVHVAoaJllD9WOz5rixGVu4gN6fFNK.jpg')" >
    <div class="container">
        <div class="row">
                    ...
                    <div class="card-body">
                        <div class="mb-5 text-center">
                            @if(get_setting('system_logo_black') != null)
                                <img src="https://taketalkbd.com/public/uploads/all/uKPE0IvHOkTzxzBPSNb92wsDueKohmWuFkOtmYIf.png" class="img mw-100 mb-4" height="40">
                            @else
                                <img src="https://taketalkbd.com/public/uploads/all/uKPE0IvHOkTzxzBPSNb92wsDueKohmWuFkOtmYIf.png" class="img mw-100 mb-4" height="40">
                            @endif
