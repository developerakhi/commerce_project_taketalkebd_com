        ...
        <div class="row">
            <div class="col-lg-6 col-md-6 col-sm-6 col-12">
              <div class="card-statistic-1">
                <div class="row">
                    <div class="card-icon">
                      ...
                      <div class="card-right">
                        <h6>৳ 14,0125014.520</h6>
                        <span>Total Income</span>
                      </div>
                </div>
                <div class="row" style="margin-top: -40px;">
                    <div class="card-icon">
                      <!--<img src="https://taketalkbd.com/public/uploads/all/SFHfN7Bk0hDc5xN5uvJrlx0UAPiJL8wMzWBUHzOk.png" style="width:25px; height:25px; background: #f64e60; color: #fff;" />-->
                      <i class="las la-random" style="color: #f64e60;"></i>
                    </div>
                      <div class="card-right">
                        <h6>৳ 14,0125014.520</h6>
                ...
                <div class="row" style="margin-top: -40px;">
                    <div class="card-icon">
                      <div class="bg-icon"><i class="las la-arrow-right"></i></div>
                    </div>
                      <div class="card-right">
                        <h6>৳ 14,0125014.520</h6>
                ...
                <div class="row" style="margin-top: -40px;">
                    <div class="card-icon">
                      <div class="bg-icon1"><i class="las la-arrow-right"></i></div>
                    </div>
                      <div class="card-right">
                        <h6>৳ 14,0125014.520</h6>
                ...
                <div class="row" style="margin-top: -40px;">
                    <div class="card-icon">
                      <div class="bg-icon2"><i class="las la-arrow-right"></i></div>
                    </div>
                      <div class="card-right">
                        <h6>৳ 14,0125014.520</h6>
            ...
            <div class="col-lg-6 col-md-6 col-sm-6 col-12">
              <div class="card-statistic-2">
                <div class="row" style="margin:0px 6px;">
                    <div class="col-4">
                        <div class="bg-grad-2 text-white text-center rounded-lg mb-4 overflow-hidden">
                            <div class="px-3 pt-3">
                                <div class="">
                    ...
                    <div class="col-4">
                        <div class="bg-grad-3 text-white text-center rounded-lg mb-4 overflow-hidden">
                            <div class="px-3 pt-3">
                                <div class="">
                                    <span class="fs-12 d-block">{{ translate('Total') }}</span>
                                    {{ translate('Order') }}
                    ...
                    <div class="col-4">
                        <div class="bg-grad-1 text-white text-center rounded-lg mb-4 overflow-hidden">
                            <div class="px-3 pt-3">
                                <div class="">
                                    <span class="fs-12 d-block">{{ translate('Total') }}</span>
                ...
                <div class="row" style="margin:0px 6px;">
                    <div class="col-4">
                        <div class="bg-grad-4 text-white text-center rounded-lg mb-4 overflow-hidden">
                            <div class="px-3 pt-3">
                                <div class="">
                                    <span class="fs-12 d-block">{{ translate('Total') }}</span>
