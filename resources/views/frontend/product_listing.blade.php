                        ...
                        <div class="aiz-filter-sidebar collapse-sidebar-wrap sidebar-xl sidebar-right z-1035">
                            ...
                            <div class="collapse-sidebar c-scrollbar-light text-left">
                                ...
                                <div class="bg-white border mb-3">
                                    <div class="fs-16 fw-700 p-3" style="background: #00a7dc;">
                                        <a href="#collapse_1" class="dropdown-toggle filter-section d-flex align-items-center justify-content-between" data-toggle="collapse" style="color:#fff;">
