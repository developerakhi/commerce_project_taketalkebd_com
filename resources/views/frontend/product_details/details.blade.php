...
<!-- EMI Info -->
    <div class="d-flex flex-wrap align-items-center">
        <div class="d-flex align-items-center mr-4">
            <!--<p class="mb-0 fw-700">EMI Available:</p> <a href="" id="openModalBtn"> EMI Details: </a>-->
        </div>
        <!-- Messase to seller -->
        
            <div class="" >
                <p class="mb-0 fw-700">EMI Available:
                <a class="hov-svg-black hov-text-black" id="openModalBtn" style="color: #e81e21; cursor: pointer;">EMI Details</a></p>
            </div>
            
            <!--<button id="openModalBtn">Open Modal</button>-->
              <div id="myModal" class="modle modal">
                <div class="modleContent modal-content">
                  <span class="modClose close">&times;</span>
                  <div class="head modal-header">
                    <h5 id="exampleModalCenterTitle" class="tl modal-title">EMI Plans</h5>
                </div>
                  <div class="modalbody modal-body">
                <div class="row">
                    <div class="col-3 col-sm-3">
                        <div class="modal_left">
                            <span class="active">AL arafah </span>
                            <span class="">BANK ASIA </span>
                            <span class="">BRAC Bank </span>
                            <span class="">City Bank </span>
                            <span class="">Community Bank </span>
                            <span class="">Dhaka Bank </span>
                            <span class="">Dutch Bangla Bank </span>
                            <span class="">EBL </span>
                            <span class="">Exim Bank </span>
                            <span class="">Jamuna Bank </span>
                            <span class="">Lanka Bangla Finance </span>
                            <span class="">MTB </span>
                            <span class="">Meghna Bank </span>
                            <span class="">Midland Bank  </span>
                            <span class="">NCC Bank </span>
                            <span class="">NRB Bank </span>
                            <span class="">NRBC Bank </span>
                            <span class="">Prime Bank </span>
                            <span class="">SCB </span>
                            <span class="">Shahjalal Islami Bank Limited </span>
                            <span class="">South Bangla Agriculture Bank </span>
                            <span class="">South East Bank </span>
                            <span class="">Standard Bank </span>
                            <span class="">UCB </span>
                        </div>
                    </div>
                    <div class="col-9 col-sm-9">
                        <div class="modal_right">
                            <div class="modal_right_total">
                                <label> Total</label>
                                
                                <input type="number" id="chosen_price" value="" placeholder="number">
                            ...
                            <table class="table">
                                <thead>
                                    <tr>
                                        ...
                                        <th scope="col">EMI</th>
                                        <th scope="col">Effective Cost</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr>
                                        <td>3</td>
                                        <td class="modal_emi">৳ 3003.33 <p>(Interest 6%)</p></td>
                                        <td class="modal_emi">৳ 9010</td></tr><tr><td>6</td>
                                        <td class="modal_emi">৳ 1515.83 <p>(Interest 7%)</p></td>
                                        <td class="modal_emi">৳ 9095</td></tr><tr><td>9</td>
                                        <td class="modal_emi">৳ 1029.44 <p>(Interest 9%)</p></td>
                                        <td class="modal_emi">৳ 9265</td>
                                    </tr>
                                    <tr>
                                        <td>12</td>
                                        <td class="modal_emi">৳ 793.33 <p>(Interest 12%)</p></td>
                                        <td class="modal_emi">৳ 9520</td></tr><tr><td>18</td>
                                        <td class="modal_emi">৳ 547.78 <p>(Interest 16%)</p></td>
                                        <td class="modal_emi">৳ 9860</td></tr><tr><td>24</td>
                                        <td class="modal_emi">৳ 428.54 <p>(Interest 21%)</p></td>
                                        <td class="modal_emi">৳ 10285</td></tr><tr><td>30</td>
                                        <td class="modal_emi">৳ 345.67 <p>(Interest 22%)</p></td>
                                        <td class="modal_emi">৳ 10370</td></tr><tr><td>36</td>
                                        <td class="modal_emi">৳ 299.86 <p>(Interest 27%)</p></td>
                                        <td class="modal_emi">৳ 10795</td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
            ...
            <div class="row no-gutters pb-3 d-none" id="chosen_price_div">
                ...
                <div class="col-sm-10">
                    <div class="product-price">
                        <strong id="chosen_price" class="fs-20 fw-700 text-primary"></strong>
                    </div>
                </div>
            </div>
