...
<a href="javascript:void(0)" class="d-flex align-items-center text-dark px-3 h-100" data-toggle="dropdown" data-display="static" title="{{translate('Cart')}}">
    <span class="mr-2">
        ...
        <i class="las la-shopping-basket" style="font-size:21px;"></i>
    </span>
    <span class="fav-icon" style="font-weight:bold; margin-left:2px;">My Cart</span>
    <span class="nav-box-text d-none d-xl-block ml-2 text-black fs-16">
