...
Route::controller(EmiController::class)->group(function () {
    Route::get('/emis', 'all_emis')->name('emis.all');
}); 

Route::controller(PrebookingController::class)->group(function(){
    Route::get('/prebooking', 'index')->name('prebooking');
    Route::post('/prebooking/store', 'store')->name('prebooking-store');
});
...
Route::controller(SearchController::class)->group(function () {
    ...
    Route::get('/emi/{emi_slug}', 'listingByEmi')->name('products.emi');
});
